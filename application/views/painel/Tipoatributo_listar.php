...
Tipos de Atributos
	<div class="pull-right">
 		<a href="{URLLISTAR}" title="Listar tipos de atributos" class="btn">Listar</a> 
 		<a href="{URLADICIONAR}" title="Adicionar tipos de atributos" class="btn"><em class="icon-plus"></em> Adicionar</a>
	</div>
</legend>
<table class="table table-bordered table-condensed">
	...
	{BLC_SEMDADOS}
	<tr>
		<td colspan="3" class="alinha-centro">Nao ha dados</td>
	</tr>
	{/BLC_SEMDADOS}
</table>
