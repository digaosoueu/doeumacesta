...
<form action="{ACAOFORM}" method="post" class="form-horizontal">
	<div class="row-fluid">
		<div class="span8">
			...
			<div class="control-group">
				<label class="control-label" for="codfabricante">Fabricante:</label>
			    <div class="controls">
			    	<select name="codfabricante" id="codfabricante" {des_fabricante} class="set-quantidade-sku">
			    		<option value="">Escolha</option>
			    		{BLC_FABRICANTE}
			    		<option value="{CODFABRICANTE}" {sel_codfabricante}>{FABRICANTE}</option>
			    		{/BLC_FABRICANTE}
			    	</select>
			    </div>
			</div>
			...
			<div class="control-group" id="quantidade-sku">
			    ...
			    <div class="controls">
			    	<input type="text" id="quantidade" name="quantidade" value="1" class="set-integer input-small" {readonly}>
			    </div>
			</div>
		</div>
		<div class="span4">
