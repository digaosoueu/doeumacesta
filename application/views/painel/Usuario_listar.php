...
Usu&aacute;rios
	<div class="pull-right">
 		...
 		<a href="{URLADICIONAR}" title="Adicionar usu&aacute;rios" class="btn"><em class="icon-plus"></em> Adicionar</a>
	</div>
</legend>
<table class="table table-bordered table-condensed">
	...
	{BLC_SEMDADOS}
	<tr>
		<td colspan="3" class="alinha-centro">N&atilde;o h&aacute; dados</td>
	</tr>
	{/BLC_SEMDADOS}
</table>
